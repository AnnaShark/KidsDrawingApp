package com.anna_shark.kidsdrawingapp
...
class MainActivity : AppCompatActivity() {
            ...
            if(requestCode == GALLERY) {
                try {
                    if (data!!.data != null){
                        ...
                        Toast.makeText(this@MainActivity, "Error in parsing image or it is corrupted", Toast.LENGTH_SHORT).show()
                    }
                } catch (e: Exception) {
                    e.printStackTrace()
                }
    ...
    private fun requestStoragePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE,
            ...
            Toast.makeText(this, "Need permission to add photo to background", Toast.LENGTH_SHORT).show()
        }
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == STORAGE_PERMISSION_CODE) {
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(this@MainActivity, "Permission granted now you can read storage", Toast.LENGTH_LONG).show()
            } else {
                Toast.makeText(this@MainActivity, "Oops you denied permission", Toast.LENGTH_LONG).show()
            }
        }
    }
    ...
    private inner class BitmapAsyncTask(val mBitmap: Bitmap): AsyncTask<Any, Void, String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            if(!result!!.isEmpty()) {
                ...
                Toast.makeText(this@MainActivity,"File is not saved successfully", Toast.LENGTH_SHORT ).show()
            }
